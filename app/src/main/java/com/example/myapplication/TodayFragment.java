...
public class TodayFragment extends Fragment {
    ...
    public TodayFragment(String staff, String group, JSONObject user_list) {
        url = "http://192.168.150.200:9000/api/tickets/support_application/?tab=1&staff_id=" + staff + "&group_id=" + group + "&format=json";
        user = user_list;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.today_tasks, container, false);
        tableLayout = view.findViewById(R.id.table);
//        String url = "http://192.168.150.200:8888/api/tickets/today_tasks/?format=json";
//        String url = "http://192.168.150.200:9000/api/tickets/support_application/?format=json";
