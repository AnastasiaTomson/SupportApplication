...
public class ThisWeekFragment extends Fragment {
    ...
    public ThisWeekFragment(String staff, String group, JSONObject user_list) {
        url = "http://192.168.150.200:9000/api/tickets/support_application/?tab=3&staff_id=" + staff + "&group_id=" + group + "&format=json";
        user = user_list;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.this_week_tasks, container, false);

//        String url = "http://192.168.150.200:8888/api/tickets/this_week_tasks/?format=json";
//        String url = "http://192.168.150.200:9000/api/tickets/support_application/?tab=3&format=json";
